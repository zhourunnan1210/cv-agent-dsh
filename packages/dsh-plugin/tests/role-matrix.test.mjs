 ...
 *
 * ⚠️ **别把 `names.ts` 的名字数当成会话里的工具数**（2026-09-17 查清，2026-09-18 更新）：
 * `names.ts` 现在声明 **21** 个 `cvagent_*` 名字，preset 实际接线 **21** 个，
 * 悬空契约 **0** 个——实验编排四工具已按用户裁定从 `names.ts` 里**删除**
 * （勘误 §12.4），不再有"有名字、无行注册"的例外。
