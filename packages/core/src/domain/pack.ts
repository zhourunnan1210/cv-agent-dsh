...
/** 格式化 pack 引用。 */
export function formatPackRef(ref: PackRef): PackRefString {
...
export interface Benchmarks {
  ...
  readonly required_protocols: readonly { readonly name: string; readonly description: string }[]
}
 ...
 */
export function freezeDomainPack(draft: DomainPackDraft, reviewer: string, now: string): FrozenDomainPack {
  if (reviewer.trim() === '') {
